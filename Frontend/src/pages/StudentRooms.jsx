...
const StudentRooms = () => {
  ...
  useEffect(() => {
    document.title = 'Browse Group Rooms — TrueEdu';
    window.scrollTo(0, 0);
  }, []);
            ...
            <div className="p-6 bg-slate-50">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-navy">₹{Math.round(selectedRoom.price * 0.1)}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="pt-2 mt-2 border-t border-slate-200 flex justify-between font-bold text-lg">
                  ...
                  <span className="text-navy">₹{selectedRoom.price + Math.round(selectedRoom.price * 0.1) + 19}</span>
                </div>
              </div>
