  ...
  <section id="refund-policy" className="bg-[#fff8e7] py-12 px-6">
    <div className="max-w-[700px] mx-auto text-center">
      ...
      <p className="text-muted text-[0.95rem] leading-relaxed mb-3">
        We hold your payment securely for 48 hours after each class. This gives you time to verify the class happened as scheduled.
      </p>
      <p className="text-muted text-[0.95rem] leading-relaxed mb-3">
        If the teacher doesn't show up or leaves early, report it within 24 hours. Our admin reviews and processes refunds within 24 hours of reporting.
      </p>
